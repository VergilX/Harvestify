...
disease_dic = {
    ...
    'banana_Cordana': """<b>Crop</b>: Banana <br/>Disease: Cordana Leaf Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Cordana musae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Maintain good air circulation, avoid overhead irrigation, remove and destroy infected leaves.
        """,

    'banana_Pestalotiopsis': """<b>Crop</b>: Banana <br/>Disease: Pestalotiopsis Leaf Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Pestalotiopsis spp.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Avoid overhead irrigation, prune affected leaves, apply fungicides if necessary.
        """,

    'banana_Sigatoka': """<b>Crop</b>: Banana <br/>Disease: Sigatoka Leaf Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Mycosphaerella musicola.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Regularly apply fungicides, remove and destroy infected leaves, promote good drainage.
        """,

    'coconut_Bud_Root_Dropping': """<b>Crop</b>: Coconut <br/>Disease: Bud Rot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Phytophthora palmivora.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Avoid waterlogging, prune affected parts, improve ventilation, apply fungicides.
        """,

    'coconut_Bud_Rot': """<b>Crop</b>: Coconut <br/>Disease: Bud Rot<br/>
        <br/> Cause of disease:
    ...
    'coconut_Gray_Leaf_Spot': """<b>Crop</b>: Coconut <br/>Disease: Gray Leaf Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Pestalotiopsis spp.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Prune affected leaves, apply copper-based fungicides.
        """,

    'coconut_Leaf_Rot': """<b>Crop</b>: Coconut <br/>Disease: Leaf Rot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Phytophthora spp.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Improve drainage, avoid overwatering, prune affected leaves, apply fungicides.
        """,

    'mango_Anthracnose': """<b>Crop</b>: Mango <br/>Disease: Anthracnose<br/>
        <br/> Cause of disease:

        <br/><br/> Fungus Colletotrichum gloeosporioides.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Prune affected branches, apply copper-based fungicides, maintain good orchard hygiene.
        """,

    'mango_Bacterial_Canker': """<b>Crop</b>: Mango <br/>Disease: Bacterial Canker<br/>
        <br/> Cause of disease:

        <br/><br/> Bacterial infection by Xanthomonas campestris pv. mangiferaeindicae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Practice good orchard hygiene by removing and destroying infected plant material. Use copper-based bactericides to prevent the spread of bacteria. Avoid overhead irrigation to reduce moisture levels which can promote bacterial growth.
        """,

    'mango_Cutting_Weevil': """<b>Crop</b>: Mango <br/>Disease: Cutting Weevil infestation<br/>
        <br/> Cause of disease:

        <br/><br/> Infestation by mango stem borer, Batocera rufomaculata.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Apply appropriate insecticides during the early stages of infestation. Prune and remove affected parts of the plant. Install pheromone traps to monitor and control weevil populations.
        """,

    'mango_Die_Back': """<b>Crop</b>: Mango <br/>Disease: Die Back<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal infection by Diplodia natalensis or Lasiodiplodia theobromae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Ensure proper sanitation by removing and destroying infected plant material. Prune affected branches to improve air circulation and reduce fungal spread. Apply fungicides containing copper or systemic fungicides as per label instructions.
        """,

    'mango_Gall_Midge': """<b>Crop</b>: Mango <br/>Disease: Gall Midge infestation<br/>
        <br/> Cause of disease:

        <br/><br/> Infestation by mango gall midge, Procontarinia matteiana.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Apply insecticides during the early stages of infestation. Prune and destroy infested plant parts. Use yellow sticky traps to monitor and control midge populations.
        """,

    'mango_Powdery_Mildew': """<b>Crop</b>: Mango <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal infection by Oidium mangiferae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Ensure proper spacing between trees for good air circulation. Apply fungicides containing sulfur or potassium bicarbonate at the first sign of infection. Remove and destroy infected leaves to prevent the spread of spores.
        """,

    'mango_Sooty_Mould': """<b>Crop</b>: Mango <br/>Disease: Sooty Mould<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal growth on honeydew excreted by sucking insects like aphids, mealybugs, or scales.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Control insect infestations through appropriate insecticide applications. Regularly wash foliage with water to remove honeydew and prevent fungal growth. Prune and destroy heavily infested plant parts.
        """,

    'papaya_Anthracnose': """<b>Crop</b>: Papaya <br/>Disease: Anthracnose<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal infection by Colletotrichum gloeosporioides.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Practice good orchard sanitation by removing and destroying infected plant material. Apply fungicides containing copper or mancozeb to prevent the spread of the fungus. Avoid overhead irrigation to reduce moisture levels which can promote fungal growth.
        """,

    'papaya_Bacterial_Spot': """<b>Crop</b>: Papaya <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Bacterial infection by Xanthomonas campestris pv. carotae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Implement crop rotation practices to reduce bacterial inoculum in the soil. Use disease-free seeds and transplants. Apply copper-based bactericides early in the growing season and at regular intervals during periods of high humidity.
        """,

    'papaya_Curl_Leaf': """<b>Crop</b>: Papaya <br/>Disease: Curl Leaf<br/>
        <br/> Cause of disease:

        <br/><br/> Physiological disorder or viral infection.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Ensure proper irrigation and fertilization to avoid physiological stress. Control aphid populations, as they can transmit viruses. Plant virus-resistant varieties if available. Maintain good orchard hygiene by removing and destroying infected plant material.
        """,

    'papaya_Ring_Spot': """<b>Crop</b>: Papaya <br/>Disease: Ring Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Viral infection by Papaya ringspot virus (PRSV).
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Plant virus-resistant varieties if available. Control aphid populations to prevent virus transmission. Remove and destroy infected plants to prevent further spread of the virus. Practice strict quarantine measures to prevent the introduction of infected plant material.
        """,

    'rice_Bacterial_Leaf_Blight': """<b>Crop</b>: Rice <br/>Disease: Bacterial Leaf Blight<br/>
        <br/> Cause of disease:

        <br/><br/> Bacterial infection by Xanthomonas oryzae pv. oryzae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Use disease-resistant rice varieties. Implement crop rotation and avoid continuous rice cultivation. Apply copper-based bactericides early in the growing season and during periods of high humidity. Ensure proper water management to avoid prolonged leaf wetness.
        """,

    'rice_Brown_Spot': """<b>Crop</b>: Rice <br/>Disease: Brown Spot<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal infection by Bipolaris oryzae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Practice good field hygiene by removing and destroying crop residues. Ensure proper water management to avoid prolonged leaf wetness. Apply fungicides containing triazoles or strobilurins at the first sign of infection. Use disease-resistant rice varieties if available.
        """,

    'rice_Leaf_Smut': """<b>Crop</b>: Rice <br/>Disease: Leaf Smut<br/>
        <br/> Cause of disease:

        <br/><br/> Fungal infection by Magnaporthe oryzae.
        <br/><br/> How to prevent/cure the disease <br/>
        <br/>Use disease-free seeds and transplants. Treat seeds with hot water or fungicidal solutions before planting. Implement crop rotation practices to reduce fungal inoculum in the soil. Apply fungicides containing azoles or strobilurins at the onset of disease symptoms.
        """,

    # Healthy plants
    'banana_healthy': """<b>Crop</b>: Banana <br/>Healthy<br/> """,

    'coconut_healthy': """<b>Crop</b>: Coconut <br/>Healthy<br/> """,

    'mango_Healthy': """<b>Crop</b>: Mango <br/>Healthy<br/> """,

    'papaya_Healthy': """<b>Crop</b>: Papaya <br/>Healthy<br/> """,

    'rice_healthy': """<b>Crop</b>: Rice <br/>Healthy<br/> """,
}
